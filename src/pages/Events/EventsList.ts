export const upcomingEventLogos = ["/event-logos/asml.jpg"];
export const upcomingEventLinks = ["https://docs.google.com/forms/d/e/1FAIpQLScuAw4QWprCEHYHNvPYP8WyVq-MAL1og0M48x2bXnw2Swm59A/viewform"];
