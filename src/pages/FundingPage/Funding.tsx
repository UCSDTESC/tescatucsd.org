...
const Funding: React.FC = () => {
	...
	const ugResearchTravelFundingLink =
		"https://ugresearch.ucsd.edu/conferences/travel-funding.html";
			...
			<div className="m-12 mt-20 flex flex-row items-center justify-between mx-auto max-w-[80%]">
				<div className="sm:max-w-full md:max-w-3/5">
					...
					<p className="font-semibold text-[22px] mb-3">
						Financial support for Jacobs School of Engineering undergraduate
						students to attend conferences and competitions. Apply for
						reimbursement of travel expenses, hotel costs, and conference fees.
					</p>
				</div>
				<img
			...
			<div className="max-w-[80%] mx-auto mb-10">
				<div className="flex flex-col items-center gap-4 mb-8">
					<p className="text-base md:text-lg text-gray-700 mb-6">
						...
						transportation and hotel costs, as well as conference or registration
						fees. This fund is a gift derived from proceeds of the Jacobs School
				...
				<section className="mb-8">
					...
					<div className="bg-gray-50 p-6 rounded-lg">
						<ol className="list-decimal list-inside text-gray-700 ml-2 space-y-2">
							<li>
								<strong>Submit an Application:</strong> Use the Google Form
							...
							<li>
								<strong>Acceptance Notification:</strong> If your application is
								accepted, you will receive a follow-up email indicating approval
								and it will include a link to the <strong>Post-Travel Form</strong>
								.
							</li>
							<li>
								<strong>Post-Travel Reimbursement:</strong> After traveling to
								your event, you must complete the mandatory Post-Travel Form and
								upload your <strong>itemized receipts</strong> and{" "}
								<strong>proof of payment</strong> for all expenses you wish to be
								reimbursed. Reimbursements are processed only after travel has
								occurred and documentation is submitted.
							</li>
						</ol>
					</div>
				</section>
				...
				<section className="mb-8">
					...
					<div className="bg-gray-50 p-6 rounded-lg">
						<ul className="list-disc list-inside text-gray-700 ml-2 space-y-2">
							<li>
								<strong>This is a reimbursement program.</strong> Students should
								expect to pay out-of-pocket initially and submit receipts for
								reimbursement.
							</li>
							<li>
								Typical reimbursements range from <strong>$300 to $500</strong>,
								depending on documented expenses and available funds.
							</li>
							<li>
				...
				<section className="mb-8">
					...
					<div className="bg-gray-50 p-6 rounded-lg">
						<p className="text-gray-700 mb-3">
							For the Dean&apos;s Office Financial Operations team to document
							your travel as business-related travel, please complete the{" "}
							<a
						...
						<ul className="list-disc list-inside text-gray-700 ml-2 space-y-2">
							<li>
								<strong>Faculty signature section:</strong> If you are not
								applying as part of a lab or research group and are not under a
						...
						<p className="text-gray-700 mt-4">
							For more information about UC San Diego student travel policies
					...
					<div className="space-y-6">
						<div className="bg-gray-50 p-6 rounded-lg">
							...
							<ul className="list-disc list-inside text-gray-700 ml-2 space-y-2">
								...
								<li>
									<strong>
										If you are applying as part of a student organization, note
										that student organizations applying for Student Travel Funds
										are not eligible for Matching Funds within the same academic
										year.
									</strong>
								</li>
							</ul>
						...
						<div className="bg-gray-50 p-6 rounded-lg">
							...
							<ul className="list-disc list-inside text-gray-700 ml-2 space-y-1">
								...
								<li>
									Number of students from your group attending this event? Write
									1 if you are the only attendee or sole applicant.
								</li>
								<li>Have you applied for Travel Funds before?</li>
								<li>
									Are you applying under a lab or research group with a Faculty
									Advisor?
								</li>
						...
						<div className="bg-gray-50 p-6 rounded-lg">
							...
							<ul className="list-disc list-inside text-gray-700 ml-2 space-y-1">
								<li>
									What is your purpose for attending this event? Describe if you
									are representing, competing, or holding a leadership role.
								</li>
								<li>
									How does attending this conference or competition support your
									academic and professional development?
								</li>
								<li>
									How will your participation benefit your research group, student
									organization, or the broader UCSD engineering community?
								</li>
								<li>
									In 2 to 3 sentences, summarize why receiving this funding is
									important.
								</li>
							</ul>
						</div>
